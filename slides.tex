...
\setmonofont[Scale=MatchLowercase]{DejaVu Sans Mono}
% For Japanese
\setCJKmainfont[CharacterWidth=Proportional,Kerning=On,Scale=0.8]{HaranoAjiMincho}
\setCJKsansfont[CharacterWidth=Proportional,Kerning=On,Scale=0.8]{HaranoAjiGothic}
