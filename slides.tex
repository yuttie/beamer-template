...
% Document Properties
\title[My Beamer Template]{My \LaTeX{} Beamer Template}
\subtitle{Sample Presentation}
\author[Y.~Taniguchi]{Yuta Taniguchi}
\institute{\url{https://github.com/yuttie/beamer-template}}
\date{2021-07-22}
...
\begin{frame}{What's this?}
  This is a repository of my \LaTeX{} Beamer template files.
\end{frame}
