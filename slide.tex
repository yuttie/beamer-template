...
% \usepackage{fontspec}
% \setmainfont[BoldFont=M+ 1mn bold]{M+ 1mn light}
% \setsansfont[BoldFont=M+ 1mn bold]{M+ 1mn light}
% \setmonofont{Ricty}

% \usepackage{luatexja-otf}
% \usepackage{luatexja-fontspec}
% \setmainjfont[BoldFont=M+ 1mn bold]{M+ 1mn light}
% \setsansjfont[BoldFont=M+ 1mn bold]{M+ 1mn light}
