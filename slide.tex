...
\setbeamertemplate{block begin}{%
  \begin{center}%
    \begin{beamercolorbox}[sep=2mm]{block body}%
      {\usebeamercolor[fg]{block title}\usebeamerfont{block title}\insertblocktitle}\par%
...
\setbeamertemplate{block alerted begin}{%
  \begin{center}%
    \begin{beamercolorbox}[sep=2mm]{block body alerted}%
      {\usebeamercolor[fg]{block title alerted}\usebeamerfont{block title alerted}\insertblocktitle}\par%
      \begin{minipage}{\linewidth - 2mm - 2mm}%
}
...
\setbeamercolor{block body example}{fg=myblack,bg=mygreen}
